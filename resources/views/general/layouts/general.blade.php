        ...
        <header id="fh5co-header" role="banner">
            <div class="container">
                <div class="header-inner">
                    <h1><a href="{{ route('general.home') }}" class="navbar-brand align-top">
                            <img src="{{asset('general/images/logo/logo.png')}}" alt="" width="75px"
                                class="logo-navbar">
                        </a></h1>
        ...
        <footer id="fh5co-footer" role="contentinfo">
            ...
            <div class="container">
                ...
                <div class="col-md-12 fh5co-copyright text-center">
                    <p>&copy; 2021. All Rights Reserved. <span>Designed with <i class="icon-heart"></i> by <a href="#"
